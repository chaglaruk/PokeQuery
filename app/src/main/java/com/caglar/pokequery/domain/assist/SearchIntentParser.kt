...
object SearchIntentParser {
    ...
    private fun isPatternNegated(normalized: String, keyword: String): Boolean {
        ...
        if (normalized.contains("hide") || normalized.contains("exclude") || normalized.contains("without")) return true
        val negationWords = listOf("not", "no", "!")
        return negationWords.any { neg ->
    ...
    private val patterns = listOf(
        ...
        IntentPattern(
            keywords = listOf("great league pvp", "great league candidate", "great league"),
        ...
        IntentPattern(
            keywords = listOf("ultra league pvp", "ultra league candidate", "ultra league"),
        ...
        IntentPattern(
            keywords = listOf("pvp", "pvp iv", "pvp candidate"),
        ...
        IntentPattern(
            keywords = listOf("favorite", "fav", "starred", "favourite", "favourites", "favorites"),
