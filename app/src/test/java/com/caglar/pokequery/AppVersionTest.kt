...
class AppVersionTest {
    ...
    @Test
    fun `display version matches the v0-dot-5-dot-5 release`() {
        assertEquals("0.5.5", AppVersion.versionName)
    }
    ...
    fun `about display string starts with PokeQuery and includes the version`() {
        ...
        assertTrue("Expected '0.5.5' in: $display", display.contains("0.5.5"))
    }
}
