...
class AppVersionTest {
    ...
    @Test
    fun `display version matches the v0-dot-5-dot-4 release`() {
        assertEquals("0.5.4", AppVersion.versionName)
    }
    ...
    fun `about display string starts with PokeQuery and includes the version`() {
        ...
        assertTrue("Expected '0.5.4' in: $display", display.contains("0.5.4"))
    }
}
