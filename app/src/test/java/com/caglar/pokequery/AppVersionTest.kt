...
class AppVersionTest {
    ...
    @Test
    fun `display version matches the v0-dot-4-dot-2 release`() {
        assertEquals("0.4.2", AppVersion.versionName)
    }
    ...
    fun `about display string starts with PokeQuery and includes the version`() {
        ...
        assertTrue("Expected '0.4.2' in: $display", display.contains("0.4.2"))
    }
}
