"""
PokeQuery v0.5.4: build a contact sheet (montage) of the motion/UI-fix smoke screenshots.

Reads every *.png in docs/screenshots/v054_motion_ui_fixes/ and tiles them into a single
grid image saved alongside them as contact_sheet.png. Deterministic order = sorted filename.

Run:  python scripts/v054_contact_sheet.py
"""
...
SHOT_DIR = os.path.join("docs", "screenshots", "v054_motion_ui_fixes")
